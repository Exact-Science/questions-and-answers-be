...
create table answers (answer_id SERIAL PRIMARY KEY, answer_question_id INTEGER, answer_body VARCHAR (1000) NOT NULL, answer_date TIMESTAMPTZ NOT NULL, answer_name VARCHAR (60) NOT NULL, answer_email VARCHAR (60) NOT NULL, answer_reported SMALLINT, answer_helpfulness SMALLINT, FOREIGN KEY (answer_question_id) REFERENCES questions (question_id));
...
-- reset sequence (autoincrementer value) for each primary key
